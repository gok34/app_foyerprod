 ...
 // $id_cita= 40;
  ...
  $estado = 2;
      ...
      //$conexion = mysqli_connect($hostname, $username, $password, $database);
       ...
       $query = "UPDATE control_reparto SET  Estado_reparto = '$estado', latitud_reparto_cierre = '$latitud', longitud_reparto_cierre = '$longitud',fecha_cierre='$fechahoy' WHERE id_reparto = '$id_reparto'";
