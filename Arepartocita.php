 ...
 // $id_cita= 40;
  ...
  $estado = 3;
      ...
      //$conexion = mysqli_connect($hostname, $username, $password, $database);
       ...
       $query = "UPDATE control_reparto SET  Estado_reparto = '$estado', latitud_reparto_asignacion = '$latitud', longitud_reparto_asignacion = '$longitud',fecha_llegada='$fechahoy' WHERE id_reparto = '$id_reparto'";
