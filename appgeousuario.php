...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_GET["codigo_vendedor"])) {
        ...
        $consulta = "select id_citas, latitud,longitud,latitudA,longitudA from citas where id_usuario={$codigo_vendedor} and   MONTH(fecha_apertura)  = MONTH(CURRENT_DATE()) and estado=2
";
