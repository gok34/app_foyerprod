 ...
 <?php
	...
	select usuarios.`names`,id_usuario from vales
INNER JOIN usuarios on usuarios.user= vales.id_usuario
where   MONTH(fecha_guarda)  = MONTH(CURRENT_DATE()) GROUP BY usuarios.names ");
            $stat1->execute();
        } else {
         ...
         <div class="content-wrapper">
                     ...
                     <div class="row mb-1">
                         ...
                         <div class="col-sm-3">
                             <ol class="breadcrumb float-sm-right">
                                 <form role="form" class="form-horizontal" method="POST" action="filtrovales.php">
                                     <div class="row">
                                         <div class="col-sm-4">
             ...
             <section class="content">
                 <div class="container-fluid">
                     ...
                     <h3 class="mt-1 mb-1">Reporte de Vales de combustible</h3>
...
INNER JOIN usuarios on usuarios.user= vales.id_usuario
where id_usuario={$row1['id_usuario']} and fecha_guarda BETWEEN '{$fecha_inicial} 00:00:00' AND '{$fecha_final} 23:59:00'  ");
                                                                $stat2->execute();
                                                                /* while($row = $stat->fetch()){
        echo "<li><a href='vervisitas.php?id=".$row['id']."' target='_blank'>".$row['imagen']."</a><br>
        <embed src='data:".$row['tipo'].";base64,".base64_encode($row['contenido'])."'width='200'/></li>";
                                                             ...
                                                             <?php
                                                                ...
                                                                ?>
                                                                     ...
                                                                     <h3 class="mt-1 mb-1">NO TIENE VALES</h3>
                                                                 <?php  } else {
                                                                    ?>
                                                         <tr>
         ...
         <footer class="main-footer">
             ...
             <strong>Copyright &copy; 2014-2022 <a href="https://adminlte.io">o</a>.</strong> All rights reserved.
         </footer>
